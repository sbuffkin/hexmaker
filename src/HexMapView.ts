...
interface FolderNode { type: "folder"; name: string; path: string; children: TPickerNode[]; }
...
class TablePickerModal extends Modal {
	...
	onOpen(): void {
		this.titleEl.style.cssText = "display:flex;align-items:center;justify-content:space-between;";
